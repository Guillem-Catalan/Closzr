...
# Used by UI hygiene panel to show valid stage transitions per deal's pipeline.
...
STAGE_DISPLAY: dict[str, dict[str, str]] = {
    ...
    "On Hold":                          {"short": "On Hold",           "abbr": "Hold"},
    "To reschedule":                    {"short": "To Reschedule",     "abbr": "Resch"},
    "To Reschedule":                    {"short": "To Reschedule",     "abbr": "Resch"},
    # DEMO
    "Demo Booked":                      {"short": "Demo Booked",       "abbr": "D"},
...
PARSER_CONFIG = {
    ...
    "macro_stage_map": {
        ...
        "To reschedule": "demo",
        "To Reschedule": "demo",
        "Factorial Project Alignment started": "evaluating",
        "Product Alignment": "evaluating",
...
def get_deal_team(partner_id: str | None, owner_email: str | None) -> str | None:
    ...
    if owner_email:
        ...
        if len(teams) > 1 and partner_id:
            partner_team = PARTNER_OBJECT_MAP.get(partner_id)
