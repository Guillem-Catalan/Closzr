...
from src.org_people import (          # noqa: F401 — re-exported for all consumers
    CRM_OWNER_MAP,
    DIRECT_SALES,
    MANAGER_EMAILS,
    PARTNERS_ORGCHART,
    PERSON_LANG_OVERRIDE,
    XL_SALES,
)
...
# ══════════════════════════════════════════════════════════════════════════════
# CRM_OWNER_MAP, PARTNERS_ORGCHART, DIRECT_SALES, XL_SALES, MANAGER_EMAILS,
# PERSON_LANG_OVERRIDE — moved to org_people.py (auto-generated from orgchart table)

TEAM_PIPELINE_CONFIG = {
    "Telefonica":    {"active": False, "pipeline_ids": ["11834984", "684767384"],    "format": "partner"},
    "TIM":           {"active": True,  "pipeline_ids": ["824790797", "3612610753"],  "format": "partner"},
    "TELEKOM":       {"active": True,  "pipeline_ids": ["824790797", "3612610753"],  "format": "partner"},
    "Mexico":        {"active": True,  "pipeline_ids": ["default", "9048177"],       "format": "ds"},
    "DIRECT_SALES":  {"active": True,  "pipeline_ids": ["default", "9048177", "831558698"]},
    "XL":            {"active": True,  "pipeline_ids": ["685413816", "3576083668"]},
}
